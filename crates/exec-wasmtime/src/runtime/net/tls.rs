...
pub static DEFAULT_PROTOCOL_VERSIONS: Lazy<[&'static rustls::SupportedProtocolVersion; 1]> =
    Lazy::new(|| [&TLS13]);

pub static DEFAULT_KX_GROUPS: Lazy<[&'static rustls::SupportedKxGroup; 3]> =
    Lazy::new(|| [&X25519, &SECP384R1, &SECP256R1]);

pub static DEFAULT_CIPHER_SUITES: Lazy<[rustls::SupportedCipherSuite; 3]> = Lazy::new(|| {
    [
